...
export const EmployeeJoinScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(t('common.success'), t('employeeJoin.success'), [
        {
          text: t('common.ok'),
          onPress: () => {
            if (user) {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <Text style={[styles.title, typography.heading, { color: colors.foreground }]}>
          {t('employeeJoin.title')}
        </Text>

        <Text style={[styles.body, typography.body, { color: colors.mutedForeground }]}>
          {t('employeeJoin.subtitle')}
        </Text>

        <Input
          placeholder={t('employeeJoin.joinCodePlaceholder')}
          value={joinCode}
        ...
        <Button
          title={t('employeeJoin.submit')}
          onPress={handleSubmit}
          loading={loading}
          fullWidth
        />

        <Button title={t('employeeJoin.back')} onPress={logout} variant="outline" fullWidth />
      </View>
    </View>
  );
};
